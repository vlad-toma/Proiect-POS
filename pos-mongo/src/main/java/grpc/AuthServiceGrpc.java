...
public final class AuthServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.Mongo.ValidateTokenRequest,
      grpc.Mongo.ValidateTokenResponse> getValidateTokenMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ValidateToken",
      requestType = grpc.Mongo.ValidateTokenRequest.class,
      responseType = grpc.Mongo.ValidateTokenResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.Mongo.ValidateTokenRequest,
      grpc.Mongo.ValidateTokenResponse> getValidateTokenMethod() {
    io.grpc.MethodDescriptor<grpc.Mongo.ValidateTokenRequest, grpc.Mongo.ValidateTokenResponse> getValidateTokenMethod;
      ...
      synchronized (AuthServiceGrpc.class) {
        if ((getValidateTokenMethod = AuthServiceGrpc.getValidateTokenMethod) == null) {
          AuthServiceGrpc.getValidateTokenMethod = getValidateTokenMethod = 
              io.grpc.MethodDescriptor.<grpc.Mongo.ValidateTokenRequest, grpc.Mongo.ValidateTokenResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "grpc.AuthService", "ValidateToken"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.Mongo.ValidateTokenRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.Mongo.ValidateTokenResponse.getDefaultInstance()))
  ...
  public static abstract class AuthServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void validateToken(grpc.Mongo.ValidateTokenRequest request,
        io.grpc.stub.StreamObserver<grpc.Mongo.ValidateTokenResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                grpc.Mongo.ValidateTokenRequest,
                grpc.Mongo.ValidateTokenResponse>(
  ...
  public static final class AuthServiceBlockingStub extends io.grpc.stub.AbstractStub<AuthServiceBlockingStub> {
    ...
    /**
     */
    public grpc.Mongo.ValidateTokenResponse validateToken(grpc.Mongo.ValidateTokenRequest request) {
  ...
  public static final class AuthServiceFutureStub extends io.grpc.stub.AbstractStub<AuthServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.Mongo.ValidateTokenResponse> validateToken(
        grpc.Mongo.ValidateTokenRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_VALIDATE_TOKEN:
          serviceImpl.validateToken((grpc.Mongo.ValidateTokenRequest) request,
              (io.grpc.stub.StreamObserver<grpc.Mongo.ValidateTokenResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AuthServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.Mongo.getDescriptor();
    }
